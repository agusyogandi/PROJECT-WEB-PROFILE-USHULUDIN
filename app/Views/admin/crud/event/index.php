    ...
    <div class="row">
        <div class="col-3">
            ...
            <div class="boxSideBar">
                ...
                <br>
                <a href="/event/create" class="btn btn-success">Tambah </a>

                <a href="/event/deleteAll" class="btn btn-danger"
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        <td><?= $i++; ?></td>
                        <td><?= $event['Judul']; ?></td>
                        <td class="center"><?= $event['Tanggal_input']; ?></td>
                        <td class="center"><?= $event['Komite']; ?></td>
                        <td class="center"><a href="/event/detail/<?= $event['Slug']; ?>"
